...
(
    ...
    "Programming" => "De <a href='https://elo.codeniacs.nl'>cursussen</a> verdiepen ICT disciplines die in de toekomst belangrijk zijn. Leerlingen gaan binnen zo'n discipline aansprekende uitdagingen aan. Aldoende <a href='https://code.codeniacs.nl'>programmeren</a> de leerlingen in Scratch, Blockly, Wikitext, HTML, CSS, Javascript en uiteindelijk zelfs in TypeScript, Sass, C#, PHP, Python en Unity. Open source software als Git, ATOM, Blender, GIMP en Inkscape wordt ingezet.",
    "Robots" => "Robots",
