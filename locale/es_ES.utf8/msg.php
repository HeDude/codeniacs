...
(
    ...
    "Programming" => "Los cursos profundizan las disciplinas de las TIC que son importantes ahora y en el futuro. Los alumnos van a trabajar dentro de una disciplina así con desafíos que les atraen. De esta manera, los estudiantes programan sus soluciones en Scratch, Blockly, Wikitext, HTML, CSS, Javascript y, finalmente, incluso en C#, PHP, Python y Unity. Se utiliza software de Open Source como Git, ATOM, Blender, GIMP e Inkscape.",
    "Robots" => "Los robots",
