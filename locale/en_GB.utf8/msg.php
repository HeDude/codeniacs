...
(
    ...
    "Programming" => "The courses deepen ICT disciplines that are important now and in the future. In each displine pupils go to work with challenges that appeal to them. Doing so, the students program their solutions in Scratch, Blockly, Wikitext, HTML, CSS, Javascript and eventually even in TypeScript, Sass, C#, PHP, Python and Unity. Open source software such as Git, ATOM, Blender, GIMP and Inkscape is used.",
    "Robots" => "Robots",
